            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(btSignup, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
...
//        car.setVisible(true);
    ...
    private void btSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSignupActionPerformed
        ...
        if (!pass1.equals(pass2)) {
            sb.append("Xác nhận mật khẩu phải giống với mật khẩu!");
        }
        ...
        if (list.checkName(name)) {
            sb.append("Tên đăng nhập đã tồn tại, hãy nhập một tên khác!");
        }
        if (!sb.isEmpty()) {
            JOptionPane.showMessageDialog(this, sb);
            return;
